...
f2a <- ggplot(meta_prob_exp_long[which(meta_prob_exp_long$group == "rare"),], aes(x = age, y = value, group = Var2, color = group2))+
  geom_point(size = 0.5)+
  geom_line()+
...
f2b <- ggplot(meta_prob_exp_long[which(meta_prob_exp_long$group == "abundant"),], aes(x = age, y = value, group = Var2, color = group2))+
  geom_point(size = 0.5)+
  geom_line()+
...
micro_prob$group <- ifelse(micro_prob$X1 > 0.7, "rare", "abundant")
...
f2c <- ggplot(micro_prob_exp_long[which(micro_prob_exp_long$group == "rare"),], aes(x = age, y = value, group = Var2, color = group2))+
  geom_point(size = 0.5)+
  geom_line()+
  labs(subtitle = TeX("Proportion of zeros at the first time-point $\\geq$ 0.7"), x = "Age (months)", y = "Proportion of zeros", color = "")+
  scale_color_manual(values=c('#56B4E9', '#E69F00', '#999999'))
f2d <- ggplot(micro_prob_exp_long[which(micro_prob_exp_long$group == "abundant"),], aes(x = age, y = value, group = Var2, color = group2))+
  geom_point(size = 0.5)+
  geom_line()+
  labs(subtitle = TeX("Proportion of zeros at the first time-point $<$ 0.7"), x = "Age (months)", y = "Proportion of zeros", color = "")+
  scale_color_manual(values=c('#56B4E9', '#E69F00', '#999999'))