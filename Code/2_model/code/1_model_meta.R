...
for (i in 1:nrow(TASK1)) {
  tryCatch({
    ...
    fwrite(TASK1[i,], file='../output/meta_pop_expected.csv', append=TRUE)
    fwrite(TASK2[i,], file='../output/meta_ind_expected_diff.csv', append=TRUE)
    fwrite(TASK3[i,], file='../output/meta_fixef.csv', append=TRUE)
