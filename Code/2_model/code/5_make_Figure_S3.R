...
s3a <- ggplot(prob_long, aes(x = Var1, y = value, group = Var2, color = color))+
  geom_point(size = 0.5)+
...
s3b <- ggplot(prob_long, aes(x = Var1, y = value, group = Var2, color = color))+
  geom_point(size = 0.5)+
  geom_line(aes(size = color))+
  scale_size_manual(values = c(Population = 3, Increase = 0.5, Decrease = 0.5),
                    labels = c(Population = "Population", Increase = "Individual Increase", Decrease = "Individual Decrease"))+
...
s3c <- ggplot(prob_long, aes(x = Var1, y = value, group = Var2, color = color))+
  geom_point(size = 0.5)+
  geom_line(aes(size = color))+
  scale_size_manual(values = c(Population = 3, Increase = 0.5, Decrease = 0.5),
                    labels = c(Population = "Population", Increase = "Individual Increase", Decrease = "Individual Decrease"))+
...
s3d <- ggplot(prob_long, aes(x = Var1, y = value, group = Var2, color = color))+
  geom_point(size = 0.5)+
  geom_line(aes(size = color))+
  scale_size_manual(values = c(Population = 3, Increase = 0.5, Decrease = 0.5),
                    labels = c(Population = "Population", Increase = "Individual Increase", Decrease = "Individual Decrease"))+
