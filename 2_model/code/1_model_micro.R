...
for (i in 1:nrow(TASK1)) {
  tryCatch({
    ...
    addALine(x=TASK1[i,],fname='../output/logistic/micro_pop_expected.csv')
    addALine(x=TASK2[i,],fname='../output/logistic/micro_ind_expected_diff.csv')
    addALine(x=TASK3[i,],fname='../output/logistic/micro_fixef.csv')
