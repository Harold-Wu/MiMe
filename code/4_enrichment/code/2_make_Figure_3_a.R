...
load("/mnt/research/quantgen/projects/harold/InfantDev2/output/logistic/pairwise_cor_signi.RData")
load("/mnt/research/quantgen/projects/harold/InfantDev2/data/meta_taxa.RData")
load("/mnt/research/quantgen/projects/harold/InfantDev2/data/micro_taxa.RData")
...
family <- read.csv("/mnt/research/quantgen/projects/harold/InfantDev2/output/logistic/enrich_test/micro_family.csv")
micro_signi <- family$group[which(family$adj_pval < 0.05)]

level3 <- read.csv("/mnt/research/quantgen/projects/harold/InfantDev2/output/logistic/enrich_test/meta_NPC_level3.csv")
...
png(file="/mnt/research/quantgen/projects/harold/InfantDev2/plots/Figure6_logit_Network.png", width = 5000, height = 5000, res=450)
