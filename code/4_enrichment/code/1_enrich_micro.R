...
f1='/mnt/research/quantgen/projects/harold/InfantDev2/output/logistic/meta_ind_expected_diff.RData'
f2='/mnt/research/quantgen/projects/harold/InfantDev2/output/logistic/micro_ind_expected_diff.RData'
load(f1)
load(f2)
...
write.csv(out_table, paste0("/mnt/research/quantgen/projects/harold/InfantDev2/output/logistic/enrich_test/micro_", test_col, ".csv"))
